 ...
 * 字符串操作符表达式构建器
 * <p>
 * 处理: LIKE, NOT_LIKE, STARTS_WITH, ENDS_WITH
 */
public class StringExpressionBuilder implements SExpressionBuilder {

  private static final Set<Operator> SUPPORTED = new HashSet<>(Arrays.asList(
      Operators.LIKE, Operators.NOT_LIKE, Operators.STARTS_WITH, Operators.ENDS_WITH
  ));
